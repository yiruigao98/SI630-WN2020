...
class attnbiLSTM(nn.Module):
    def __init__(self, embedding_dim, hidden_dim,  tagset_size, vec=None):
        super().__init__()
        self.hidden_dim = hidden_dim
        self.batch_size = 1
        ...
        self.encoder = nn.LSTM(embedding_dim, hidden_dim, num_layers=2, bidirectional=True, dropout=0.6)
